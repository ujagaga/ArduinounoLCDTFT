...
#elif (DRIVER_ID==ID_9341)

#else
#error UNKNOWN DISPLAY DRIVER. Please configure driver type in this file
#endif
...
#elif (DRIVER_ID==ID_9341) || (DRIVER_ID==ID_HX8357D)
  {
    uint32_t t;
...
void Adafruit_TFTLCD::fillScreen(uint16_t color) {
  ...
  #elif (DRIVER_ID==ID_9341) || (DRIVER_ID==ID_7575) || (DRIVER_ID==ID_HX8357D) 
  {
