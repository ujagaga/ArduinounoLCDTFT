...
//void TFTLCD_pushColors2(uint8_t * block, int16_t n, bool first)
//{
//    uint16_t color;
//    uint8_t h, l;
//    CS_ACTIVE();
...
//void TFTLCD_pushColors3(const uint8_t * block, int16_t n, bool first)
//{
//    uint16_t color;
//    uint8_t h, l;
//    CS_ACTIVE();
...
//	_lcd_capable = AUTO_READINC | MIPI_DCS_REV1 | MV_AXIS | READ_24BITS;
	...
	uint8_t *p = (uint8_t *) ILI9341_regValues_2_4;
	uint8_t dat[16];
	int16_t size = sizeof(ILI9341_regValues_2_4);
